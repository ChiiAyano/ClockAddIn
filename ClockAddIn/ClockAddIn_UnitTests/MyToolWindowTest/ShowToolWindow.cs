...
using Company.ClockAddIn;

namespace ClockAddIn_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new ClockAddInPackage() as IVsPackage;
            ...
            MethodInfo method = typeof(ClockAddInPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
